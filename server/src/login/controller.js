...
var AuthenticatePayload = /** @class */ (function () {
    function AuthenticatePayload() {
    }
    __decorate([
        class_validator_1.IsString()
    ], AuthenticatePayload.prototype, "email");
    __decorate([
        class_validator_1.IsString()
    ], AuthenticatePayload.prototype, "password");
    return AuthenticatePayload;
}());
var LoginController = /** @class */ (function () {
    function LoginController() {
    }
    LoginController.prototype.authenticate = function (_a) {
        var email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var user, jwt;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, entity_1["default"].findOne({ where: { email: email } })];
                    case 1:
                        user = _b.sent();
                        if (!user) {
    ...
    ], LoginController.prototype, "authenticate");
